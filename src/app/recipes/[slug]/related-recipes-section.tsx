...
export function RelatedRecipesSection({ relatedRecipes, category }: RelatedRecipesSectionProps) {
  ...
  return (
    <section className="grid gap-6 rounded-[2rem] border border-amber-200/70 bg-[linear-gradient(180deg,rgba(255,245,230,0.92)_0%,rgba(255,238,214,0.82)_100%)] px-6 py-6 shadow-[0_18px_50px_rgba(120,53,15,0.08)] sm:px-8 sm:py-8 xl:px-10 xl:py-10">
      ...
      {totalPages > 1 ? (
        <div className="border-t border-amber-300/40 pt-5 text-sm text-stone-700">
          <div className="flex flex-col items-center gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex w-full flex-col items-center gap-2 sm:flex-row sm:w-auto">
              <button
                ...
                className="inline-flex w-full items-center justify-center whitespace-nowrap rounded-full border border-amber-200/80 bg-amber-50/90 px-5 py-3 text-sm font-semibold text-amber-900 shadow-[0_10px_24px_rgba(217,119,6,0.12)] transition hover:border-amber-300 hover:bg-amber-100 hover:text-amber-950 disabled:cursor-not-allowed disabled:border-amber-200 disabled:bg-amber-100 disabled:text-amber-400 sm:w-auto"
              >
                Назад
              </button>
              <span className="w-full text-center rounded-full border border-amber-300/60 bg-white/80 px-4 py-2 font-semibold text-stone-700 sm:w-auto">
